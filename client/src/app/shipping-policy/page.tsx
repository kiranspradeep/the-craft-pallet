...
function Stepper({ steps, activeColor = "var(--text-primary)", connectorColor = "var(--border-soft)" }: { steps: Step[], activeColor?: string, connectorColor?: string }) {
  return (
        ...
        <div className="tcp-container" style={{ maxWidth: "760px" }}>
          ...
          <Section id="shipping-charges" title="4. Shipping Charges">
            ...
            >
              {/* Table Header */}
              <div
                className="shipping-table-header"
                style={{
                  display:             "grid",
          ...
          <Section id="delivery-address" title="6. Delivery Address">
            <InfoBox variant="warning">
              <span style={{ color: "#DC2626", fontWeight: 700 }}>
                ...
                phone number.
              </span> Please double-check your address before completing your order.
            </InfoBox>
            <P>
          ...
          <Section id="tracking" title="7. Order Tracking">
            ...
            <Stepper
              ...
              connectorColor="rgba(142,159,130,0.3)"
            />
            ...
            <P>
              ...
              <a
                ...
                style={{ color: "var(--brand)", textDecoration: "underline", fontWeight: 500, display: "inline-flex", alignItems: "center", gap: "4px" }}
              >
                India Post website
          ...
          <Section id="contact" title="10. Contact Us">
            ...
            >
              ...
              <p style={{ fontSize: "13px", color: "var(--text-secondary)", display: "flex", alignItems: "center", gap: "8px" }}>
...
const styleInjections = (
  <style>{`
    @media (max-width: 580px) {
      ...
      .shipping-table-row > span:first-of-type {
        font-weight: 600;
