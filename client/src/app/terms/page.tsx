...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://craftpallet.com/terms",
  },
  openGraph: {
    title: "Terms & Conditions | The Craft Pallet",
    description:
      "Read The Craft Pallet's terms and conditions for personalised gifts, orders, payments, shipping, cancellations, and customer responsibilities.",
    url: "https://craftpallet.com/terms",
    type: "website",
  },
};
...
const ORDER_FLOW = [
  {
    ...
    detail: "Products and customisation selected",
  },
  {
    step: "2",
    label: "Order created",
    detail: "Order ID generated, awaiting payment",
  },
  {
    step: "3",
    label: "Payment completed",
    detail: "Payment processed securely via Razorpay",
  },
  {
    step: "4",
    label: "Order confirmed",
    detail: "Payment verified, order enters our queue",
  },
  {
    step: "5",
    label: "Photograph review",
    detail: "Uploaded photos reviewed and verified by our team",
  },
  {
    step: "6",
    label: "Production",
    detail: "Your personalised product is handcrafted",
  },
  {
    step: "7",
    label: "Dispatch",
    detail: "Order packed and handed to courier",
  },
  {
    step: "8",
    label: "Delivery",
    detail: "Order delivered to your address",
  },
];
    ...
    <div style={{ backgroundColor: "var(--bg)", padding: "72px 0 120px" }}>
      <div className="tcp-container" style={{ maxWidth: "760px" }}>
        ...
        <Section id="order-review" title="3. Reviewing Your Order">
          <P>Before completing your order, please carefully review:</P>
        ...
        <Section id="photographs" title="4. Customer-Uploaded Photographs">
          ...
          <P>By uploading photographs to our website, you confirm that:</P>
          ...
          <P>You must not upload photographs or content that:</P>
